...
const ExpenseForm = (props) => {
  ...
  const submitHandler = (event) => {
    //prevents request being sent and prevents a page reload; resets the data after pressing submit
    event.preventDefault();
    setEnteredTitle("");
    setEnteredAmount("");
    setEnteredDate("");

    //Create a form data object to pass it up to the parent component
    const expenseData = {
      title: enteredTitle,
